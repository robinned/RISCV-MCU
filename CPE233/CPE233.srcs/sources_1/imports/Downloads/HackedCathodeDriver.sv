        ...
        case (r_disp_digit)
            2'b00: begin
                ...
                case (HEX[3:0])
                    ...
                    4'b0001: CATHODES = 8'b10000110; //P
                    4'b0010: CATHODES = 8'b11100011; //L
                    4'b0011: CATHODES = 8'b10101100; //Y
                    4'b0100: CATHODES = 8'b11110110; //r
                    4'b0101: CATHODES = 8'b11110010; //c
