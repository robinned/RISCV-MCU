...
### LEDs
set_property PACKAGE_PIN U16 [get_ports {RAMP[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[0]}]
set_property PACKAGE_PIN E19 [get_ports {RAMP[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[1]}]
set_property PACKAGE_PIN U19 [get_ports {RAMP[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[2]}]
set_property PACKAGE_PIN V19 [get_ports {RAMP[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[3]}]
...
###Pmod Header JA
###Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {LEDS[0]}]					
...
###Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {RAMP[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[0]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {RAMP[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[1]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {RAMP[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[2]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {RAMP[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RAMP[3]}]
###Sch name = JC7
